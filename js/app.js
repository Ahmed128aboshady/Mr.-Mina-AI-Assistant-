  ...
  _matchCurriculumQuestion(question) {
    return new Promise((resolve) => {
      setTimeout(() => {
        ...
        // 2.5) قاموس التبسيط المتدرج الشامل (Multi-Tier Progressive Simplification)
        const SIMPLIFIED_EXPLANATIONS = {
          'u1_l1_atom': {
            title: 'تركيب الذرة ومستويات الطاقة',
            tier1: {
          ...
          'u1_l2_periodic': {
            title: 'الجدول الدوري وتصنيف العناصر',
            tier1: {
          ...
          'u1_l3_matter': {
            title: 'المادة وخواصها وسر الكثافة',
            tier1: {
          ...
          'u2_l1_energy': {
            title: 'الطاقة وصورها وطاقة الوضع والحركة',
            tier1: {
              answer: `تخيل طاقة الوضع والحركة زي **المرجوحة أو الزحليقة**:\n• وأنت فوق خالص على أعلى نقطة في المرجوحة وواقف للحظة: طاقتك كلها **طاقة وضع مخزونة** مستعدة تنطلق.\n• أول ما تسيب نفسك وتنزل تجري بسرعة لتحت: طاقة الوضع بتتحول فوراً لـ **طاقة حركة سريعة**.\n• مجموع الاتنين مع بعض ثابت دايماً واسمه **الطاقة الميكانيكية** (قانون بقاء الطاقة).`,
              spokenText: `تخيل طاقة الوضع والحركة بالمرجوحة، فوق خالص طاقة وضع متخزنة، وأول ما تنزل تجري تتحول لطاقة حركة، ومجموعهم مع بعض الطاقة الميكانيكية ثابت دايماً.`
            },
            tier2: {
              answer: `الكبسولة السحرية للطاقة في 3 نقط:\n\n1. **طاقة الوضع:** شحن وتخزين (ط = الوزن × الارتفاع).. تزيد كل ما تطلع لفوق.\n2. **طاقة الحركة:** سرعة وانطلاق (ح = ½ الكتلة × مربع السرعة).. تزيد بزيادة السرعة.\n3. **قانون بقاء الطاقة:** الطاقة لا تفنى ولا تستحدث من العدم، بل تتحول من صورة لأخرى!`,
              spokenText: `الكبسولة السريعة: طاقة الوضع بتزيد بالارتفاع والوزن، وطاقة الحركة بتزيد بالسرعة، ومجموعهم الطاقة الميكانيكية ثابتة دايماً!`
            }
          },
          'u2_l2_forces': {
            title: 'القوى الأساسية في الطبيعة والمغناطيسية',
            tier1: {
              answer: `تخيل القوى دي زي **الحبال الخفية اللي ماسكة الكون**:\n• **الجاذبية:** مغناطيس كوكب الأرض اللي شادك لتحت ومخلي رجلك ثابتة على الأرض (الوزن = الكتلة × عجلة الجاذبية).\n• **الكهرومغناطيسية:** الكهربا والمغناطيس إخوات.. لما يمر تيار كهربي في سلك يتحول لمغناطيس يشيل أطنان حديد (زي أوناش الخردة والموتور).`,
              spokenText: `القوى هي الحبال الخفية، الجاذبية بتشدنا لمركز الأرض، والكهرباء والمغناطيسية وجهين لعملة واحدة تولد حركة وقوة.`
            },
            tier2: {
              answer: `الكبسولة السحرية للقوى:\n\n1. **الوزن:** قوة جذب الأرض للجسم (يتغير بتغير المكان، والكتلة ثابتة لا تتغير أبداً).\n2. **المغناطيس الكهربي:** تيار كهربي يولد مجالاً مغناطيسياً.\n3. **الدينامو:** حركة تولد كهرباء.. **الموتور:** كهرباء تولد حركة ودوران!`,
              spokenText: `الكبسولة السريعة: الوزن يتغير بالمكان والكتلة ثابتة، والدينامو يحول الحركة لكهرباء، والموتور يحول الكهرباء لحركة!`
            }
          },
          'u3_l1_cells': {
            title: 'الخلية وحدة بناء الكائن الحي',
            tier1: {
              answer: `تخيل الخلية دي زي **شقة صغيرة كاملة الخدمات**:\n• **الجدار والغشاء:** سور العمارة وباب الشقة اللي بيحميها وينظم مين يدخل ومين يخرج.\n• **النواة:** صاحب البيت ومدير العمليات والمسؤول عن انقسام الخلية.\n• **الميتوكوندريا:** محول الكهربا اللي بيولد الطاقة للخلية.\n• **البلاستيدات الخضراء (في النبات بس):** المطبخ اللي بيطبخ الأكل بنور الشمس (البناء الضوئي).`,
            ...
            tier2: {
              answer: `الكبسولة السحرية للخلية:\n\n1. هي **أصغر وحدة بناء ووظيفة** في جسم الكائن الحي.\n2. **الخلية النباتية:** تتميز بجدار خلوي قوي وبلاستيدات خضراء لصنع الغذاء.\n3. **الخلية الحيوانية:** محاطة بغشاء بلازمي مرن وتحتوي على نواة وسيتوبلازم.`,
          ...
          'u3_l2_adaptation': {
            title: 'تنوع الكائنات الحية وطرق التكيف',
            tier1: {
              answer: `تخيل التكيف زي **تغيير لبسك في الصيف والشتاء**:\nالكائنات الحية بتغير نفسها عشان تعيش وتتحمل البيئة وتتجنب الانقراض:\n• **تركيبي (في جسمها):** زي خف الجمل العريض عشان ميرغزش في الرملة السخنة، وحافر الحصان للجري على الصخور.\n• **وظيفي (إفرازات داخلية):** زي إفراز السم في التعبان والعرق في الإنسان.\n• **سلوكي (تصرفات ومواعيد):** زي هجرة الطيور في الشتاء والبيات الشتوي للضفادع.`,
              spokenText: `التكيف يعني الكائن بيغير نفسه عشان يعيش، تركيبي في أعضاء جسمه، وظيفي في إفرازاته، وسلوكي في تصرفاته ومواعيده.`
            },
            tier2: {
              answer: `الكبسولة السحرية للتكيف في 4 نقط:\n\n1. **تركيبي:** جزء من الجسم (خف الجمل، منقار الصقر، حافر الحصان).\n2. **وظيفي:** إفراز سوائل داخلية (سم الأفعى، إفراز العرق).\n3. **سلوكي:** تصرف بميعاد (هجرة الطيور، خمول صيفي، بيات شتوي).\n4. **الهدف:** البحث عن الطعام، الهروب من الأعداء، وتحمل قسوة المناخ!`,
              spokenText: `الكبسولة السريعة: تركيبي يعني عضو في الجسم، وظيفي يعني إفرازات، وسلوكي يعني تصرفات وهجرة، والهدف النجاة والاستمرار!`
            }
          },
          'u4_l1_earth_space': {
            title: 'كوكب الأرض والبيئة الفضائية',
            tier1: {
              answer: `تخيل كوكب الأرض زي **بيضة مسلوقة في الفضاء**:\n• **القشرة:** الطبقة الصلبة الرفيعة الخارجية اللي بنمشي ونبني عليها.\n• **الوشاح (البياض):** طبقة صخور سخنة منصهرة تحت القشرة.\n• **اللب (الصفار):** قلب الأرض الحديدي السخن جداً المسؤول عن الجاذبية والمجال المغناطيسي.\n• **الغلاف الجوي والأوزون:** الدرع والنظارة الشمسية اللي بتحمينا من النيازك والأشعة فوق البنفسجية الضارة.`,
              spokenText: `كوكب الأرض زي بيضة مسلوقة، قشرة خارجية صلبة، وشاح منصهر، ولب حديدي في المركز، وحواليها غلاف جوي يحمي الحياة.`
            },
            tier2: {
              answer: `الكبسولة السحرية لكوكب الأرض:\n\n1. يتركب من 3 طبقات رئيسية: قشرة، وشاح، لب.\n2. يغطي الماء 71% من مساحته (كوكب الحياة الأزرق).\n3. الغلاف الجوي غني بالأكسجين، وطبقة الأوزون تحمينا من الأشعة فوق البنفسجية الضارة.`,
              spokenText: `الكبسولة السريعة: الأرض ثلاث طبقات قشرة ووشاح ولب، المية واحد وسبعين في المية، والأوزون بيحمينا من الأشعة الضارة!`
            }
          },
          'u4_l2_eclipses': {
            title: 'ظواهر الكسوف والخسوف الفلكية',
            tier1: {
              answer: `تعال نفهم الكسوف والخسوف بلعبة **كشاف الموبايل في أوضة ضلمة**:\n• لما تحط كفك قدام الكشاف، كفك بيحجب النور ويعمل ظل على الحيطة.\n• **كسوف الشمس (بالنهار):** القمر بيقف بين الشمس والأرض على خط واحد، فيحجب ضوء الشمس عننا كام دقيقة.\n• **خسوف القمر (بالليل):** الأرض بتقف بين الشمس والقمر، فتحجب ضوء الشمس عن القمر فيضلم ويحمر.`,
              spokenText: `تخيل الكسوف والخسوف بكشاف الموبايل، في كسوف الشمس القمر في النص بيحجب ضوء الشمس بالنهار، وفي خسوف القمر الأرض في النص بالليل تحجب الضوء عن القمر.`
            },
            tier2: {
              answer: `الكبسولة السحرية للكسوف والخسوف في كلمتين ونص:\n\n1. **الشرط الأساسي:** الشمس والأرض والقمر على استقامة وخط واحد.\n2. **قمر في النص:** كسوف شمس (بالنهار وممنوع النظر للشمس مباشرة بدون نظارات خاصة).\n3. **أرض في النص:** خسوف قمر (بالليل ولا يسبب أي ضرر للعين).`,
              spokenText: `الكبسولة السريعة: قمر في النص يعني كسوف شمس بالنهار، وأرض في النص يعني خسوف قمر بالليل.. وكلهم على استقامة واحدة!`
            }
          }
        };
