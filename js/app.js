...
class AppController {
  constructor() {
    ...
    this._lastTopicId = 'u1_l1_atom';
    this._simplificationLevel = 0;
        ...
        if (isGenericExplain) {
          ...
          if (activeLesson) {
            ...
            return;
                ...
                // 2.5) قاموس التبسيط المتدرج الشامل (Multi-Tier Progressive Simplification) - 12 درساً معتمداً
        const SIMPLIFIED_EXPLANATIONS = {
          'u1_l1_atom': {
            title: 'تركيب الذرة',
            tier1: {
              answer: `ولا يهمك يا بطل! تعال نبسطها بتشبيه بسيط جداً من حياتنا:

تخيل الذرة دي عاملة زي **المجموعة الشمسية** بالظبط:
• **الشمس في المركز وثابتة:** دي **النواة** اللي فيها الشحنة الموجبة (البروتونات) والتعادل (النيوترونات).
• **الكواكب اللي بتلف حواليها بسرعة البرق:** دي **الإلكترونات** خفيفة جداً وشحنتها سالبة.

وليه الذرة متعادلة؟ زي لما يكون عندك كفتين ميزان متساويين تماماً: عدد الموجب جوة النواة = عدد السالب اللي بيلف برة!`,
              spokenText: `ولا يهمك يا دكتور! تخيل الذرة عاملة زي المجموعة الشمسية، النواة في المركز زي الشمس، والإلكترونات بتلف حواليها زي الكواكب خفيفة وسريعة، وعدد الموجب جوة قد السالب برة عشان كده متعادلة.`
            },
            tier2: {
              answer: `خدها بقى في **كبسولة سحرية في كلمتين ونص** عشان تثبت في دماغك وما تنساهاش أبداً:

1. **النواة:** بيت تقيل وموجب (+) قاعد في النص وواخد كل وزن الذرة.
2. **الإلكترونات:** عيال شقية وخفيفة بتجري وتلف حوالين البيت وسالبة (-).
3. **القانون الذهبي:** عدد الموجب جوة = عدد السالب برة.. عشان كده الذرة متعادلة ومبسوطة!

💡 تعال نلفها ونجربها بنفسنا في المعمل ثلاثي الأبعاد وهتفهمها في ثانية:`,
              spokenText: `خدها بقى في كبسولة سحرية: النواة بيت تقيل وموجب في النص، والإلكترونات عيال شقية وسالبة بتلف حواليه، والموجب قد السالب يعني متعادلة.. تعال نجربها في المعمل 3D وتشوفها بنفسك!`
            }
          },
          'u1_l2_periodic': {
            title: 'الجدول الدوري لتصنيف العناصر',
            tier1: {
              answer: `ولا يهمك يا بطل! تخيل الجدول الدوري ده زي **دولاب منظم في السوبر ماركت**:
بدل ما نرمي كل البضاعة مفركشة، رتبنا العناصر حسب أرقامها الذرية وخواصها:
• **الصفوف الأفقية (الدورات):** زي أرفف الدولاب.. كل رف بيمثل عدد مستويات الطاقة المشغولة بالإلكترونات.
• **الأعمدة الرأسية (المجموعات):** زي الأصناف المتشابهة.. العناصر اللي في نفس العمود بتتصرف زي بعض كيميائياً عشان عندها نفس عدد الإلكترونات في آخر مستوى!`,
              spokenText: `تخيل الجدول الدوري زي دولاب منظم في السوبر ماركت، الصفوف الأفقية بتمثل مستويات الطاقة، والأعمدة الرأسية عناصر متشابهة في الخواص والتصرف الكيميائي.`
            },
            tier2: {
              answer: `الكبسولة السحرية للجدول الدوري في 3 نقط:

1. هو **خريطة سحرية** رتبت كل عناصر الكون عشان نلاقي أي عنصر في ثانية.
2. كل صف أفقي = دورة، وكل عمود رأسي = عيلة شبه بعض في الخواص والتفاعلات.
3. رتبها موزلي وبور حسب **العدد الذري** تصاعدياً.`,
              spokenText: `الكبسولة السريعة: الجدول الدوري خريطة لكل عناصر الكون، الصفوف دورات والأعمدة مجموعات متشابهة، ومترتب تصاعدياً بالعدد الذري!`
            }
          },
          'u1_l3_matter': {
            title: 'المادة وخصائصها',
            tier1: {
              answer: `تعال نبسط الكثافة بتشبيه **الزحمة جوة الأوتوبيس**:
• لو الأوتوبيس فيه 100 راكب مزنوقين في مساحة صغيرة = كثافته عالية جداً (زي الحديد فيغطس ويغوص في المية).
• لو نفس الأوتوبيس فيه راكبين اتنين بس = كثافته خفيفة (زي الخشب والزيت فيعوم ويطفو فوق المية).

القانون بالبلدي: **الكثافة = الكتلة ÷ الحجم**.. أي حاجة كثافتها أقل من 1 (كثافة المية) تعوم وتطفو، وأكبر من 1 تغطس وتغوص!`,
              spokenText: `الكثافة عاملة زي الزحمة جوة الأوتوبيس، المليان بيغطس ويغوص زي الحديد، والخفيف بيعوم ويطفو زي الخشب والزيت، والقانون الكتلة على الحجم.`
            },
            tier2: {
              answer: `الكبسولة السحرية للكثافة في كلمتين ونص:

1. **الكثافة = الكتلة ÷ الحجم** (تقل المادة بالنسبة لحجمها).
2. **الخفيف يطفو:** زي الزيت والفلين وبالونات الهيليوم.
3. **الثقيل يغوص:** زي مسمار الحديد.
4. **سؤال امتحانات شهير:** لا نطفئ حرائق البترول بالماء لأن كثافة البترول أقل من الماء فيطفو ويظل مشتعلاً!`,
              spokenText: `الكبسولة السحرية: الكثافة تساوي الكتلة على الحجم، الخفيف بيطفو والثقيل بيغوص، وحرائق البترول مبتطفيش بالمية لأن الزيت بيطفو فوقيها!`
            }
          },
          'u1_l4_bonds': {
            title: 'الروابط الكيميائية',
            tier1: {
              answer: `تخيل الروابط دي عاملة زي **علاقة الصحاب ببعض**:
• **الرابطة الأيونية (واحد كريم وواحد محتاج):** الفلز كريم يتنازل عن إلكترون ويديه للّافلز، فيتحول لموجب والتاني لسالب وينجذبوا لبعض زي المغناطيس (زي ملح الطعام NaCl).
• **الرابطة التساهمية (اتنين صحاب بيشاركوا):** كل واحد فيهم يشارك بسندوتشاته عشان هما الاتنين يشبعوا ويكملوا مستواهم الأخير (زي جزيء المية H2O).`,
              spokenText: `تخيل الروابط زي الصحاب، الأيونية واحد كريم يتنازل عن إلكترون وواحد يكتسب وينجذبوا، والتساهمية اتنين صحاب بيشاركوا إلكترونات بالتساوي عشان يستقروا.`
            },
            tier2: {
              answer: `الكبسولة السحرية للروابط الكيميائية:

1. **أيونية:** فقد واكتساب (تجاذب كهربي قوي بين أيون موجب وأيون سالب).
2. **تساهمية:** مشاركة وتقاسم للإلكترونات بين لافلزات.
3. **الهدف الأساسي:** كل ذرة تكمل 8 إلكترونات في آخر مستوى وتستقر!`,
              spokenText: `الكبسولة السريعة: أيونية يعني فقد واكتساب وتجاذب شحنات، وتساهمية يعني مشاركة، والهدف قفل المستوى الأخير بتمانية إلكترونات!`
            }
          },
          'u2_l1_electric': {
            title: 'القوى الكهربية',
            tier1: {
              answer: `تعال نبسط القوى الكهربية بتشبيه **الدلك والمغناطيس الخفي**:
• لما تدلك مسطرة بشعرك أو صوف، بتجمع عليها شحنات سالبة إضافية بتجذب الورق الخفيف.
• الشحنات زي الناس: **المتشابهين يتخانقوا ويتنافروا (+ مع + أو - مع -)**، و**المختلفين ينجذبوا لبعض (+ مع -)**!
• والتيار الكهربي زي نهر جاري من الإلكترونات بيمشي في سلك النحاس وينور اللمبة في دائرة مقفولة.`,
              spokenText: `القوى الكهربية زي شحنات الدلك، المتشابه يتنافر والمختلف يتجاذب، والتيار نهر إلكترونات بيجري في سلك النحاس وينور اللمبة.`
            },
            tier2: {
              answer: `الكبسولة السحرية للقوى الكهربية:

1. **القاعدة الذهبية:** الشحنات المتشابهة تتنافر والمختلفة تتجاذب.
2. **التيار الكهربي:** سيل إلكترونات سالبة تتدفق في دائرة مغلقة.
3. **الموصلات والعوازل:** النحاس يوصل كهرباء، والبلاستيك عازل يحمينا من الصعق!`,
              spokenText: `الكبسولة السريعة: المتشابه يتنافر والمختلف يتجاذب، والتيار سيل إلكترونات، والنحاس موصل والبلاستيك عازل!`
            }
          },
          'u2_l2_magnetic': {
            title: 'القوى المغناطيسية',
            tier1: {
              answer: `تخيل القوى المغناطيسية دي زي **قوة الأبطال الخارقين في الأفلام**:
• المغناطيس عنده قطب شمالي وجنوبي، وحواليه هالة غير مرئية اسمها **المجال المغناطيسي**.
• المعجزة الكبرى: **الكهرباء بتصنع مغناطيس!** لما تلف سلك كهربي حول مسمار حديد يتحول لمغناطيس كهربي يشيل أطنان حديد في المصانع، والموتور يحول الكهربا لدوران وحركة!`,
              spokenText: `القوى المغناطيسية هالة غير مرئية حول المغناطيس، الشمالي مع الجنوبي يتجاذبوا والمتشابهين يتنافروا، وسريان الكهربا في سلك بيصنع مغناطيس كهربي قوي.`
            },
            tier2: {
              answer: `الكبسولة السحرية للقوى المغناطيسية:

1. **الأقطاب:** المتشابهة تتنافر والمختلفة تتجاذب.
2. **المغناطيس الكهربي:** تيار كهربي يصنع مغناطيساً مؤقتاً في ثانية.
3. **الموتور:** كهرباء ➔ حركة.. **الدينامو:** حركة ➔ كهرباء!`,
              spokenText: `الكبسولة السريعة: الأقطاب المتشابهة تتنافر والمختلفة تتجاذب، والموتور يحول الكهربا لحركة، والدينامو يحول الحركة لكهربا!`
            }
          },
          'u2_l3_gravity': {
            title: 'قوى الجاذبية',
            tier1: {
              answer: `تعال نفهم الجاذبية بتشبيه **مغناطيس كوكب الأرض العملاق**:
• الأرض عندها جاذبية بتشد كل حاجة لمركزها لأسفل ومخلية المية والغلاف الجوي ثابتين ومبنطيرش في الفضاء.
• ولغز الكتلة والوزن: **كتلتك** هي لحمك وعضمك وثابتة في أي كوكب.. لكن **وزنك** هو قوة شد الأرض ليك (الوزن = الكتلة × 9.8).. على القمر وزنك بيبقى سدس وزنك عشان القمر أصغر وجاذبيته أضعف!`,
              spokenText: `الجاذبية مغناطيس الأرض اللي شاددنا لتحت، وكتلتك ثابتة في أي مكان، لكن وزنك قوة جذب الأرض ويساوي الكتلة في عجلة الجاذبية، وعلى القمر سدس وزنك.`
            },
            tier2: {
              answer: `الكبسولة السحرية للجاذبية في 3 نقط:

1. **الكتلة:** ثابتة لا تتغير أبداً في أي مكان في الكون.
2. **الوزن:** يتغير بتغير المكان والجاذبية.. والقانون: **الوزن = الكتلة × عجلة الجاذبية**.
3. **وزن القمر = ⅙ وزن الأرض**، ومركز الثقل هو نقطة تأثير جذب الأرض للجسم.`,
              spokenText: `الكبسولة السريعة: الكتلة ثابتة والوزن يتغير ويساوي الكتلة في العجلة، ووزنك على القمر سدس وزنك على الأرض!`
            }
          },
          'u3_l1_cells': {
            title: 'الخلايا والحياة',
            tier1: {
              answer: `تخيل الخلية دي زي **شقة صغيرة كاملة الخدمات**:
• **الجدار والغشاء:** سور العمارة وباب الشقة اللي بيحميها وينظم مين يدخل ومين يخرج.
• **النواة:** صاحب البيت ومدير العمليات والمسؤول عن انقسام الخلية والمادة الوراثية.
• **الميتوكوندريا:** محول ومحطة الكهربا اللي بتولد الطاقة للخلية.
• **البلاستيدات الخضراء (في النبات بس):** المطبخ اللي بيطبخ الأكل بنور الشمس (البناء الضوئي).`,
              spokenText: `الخلية زي شقة صغيرة، النواة هي المدير، والغشاء هو الباب، والميتوكوندريا هي محطة الطاقة، والبلاستيدات الخضراء هي مطبخ النبات اللي بيعمل الأكل بالشمس.`
            },
            tier2: {
              answer: `الكبسولة السحرية للخلية:

1. هي **أصغر وحدة بناء ووظيفة** في جسم الكائن الحي.
2. **الخلية النباتية:** تتميز بجدار خلوي قوي وبلاستيدات خضراء لصنع الغذاء وفجوة كبيرة.
3. **الخلية الحيوانية:** محاطة بغشاء بلازمي مرن وتحتوي على سنتروسوم لانقسام الخلية.`,
              spokenText: `الكبسولة السريعة: الخلية أصغر طوبة في الكائن الحي، النباتية عندها جدار وبلاستيدات لصنع الغذاء، والحيوانية عندها غشاء مرن ونواة وسيتوبلازم.`
            }
          },
          'u3_l2_traits': {
            title: 'الصفات العامة للكائنات الحية',
            tier1: {
              answer: `تخيل التكيف والصفات الحية زي **تجهيزات الرحلات والمغامرات**:
• الكائن الحي بيتميز بـ 7 خصائص: تغذية، تنفس، إخراج، نمو، حركة، إحساس، تكاثر.
• وعشان يعيش في البيئة الصعبة بيتكيف بـ 3 طرق: **تركيبي** في جسمه (زي خف الجمل العريض عشان ميرغزش في الرملة)، و**وظيفي** بإفرازات (زي سم الثعبان والعرق)، و**سلوكي** بتصرفات (زي هجرة الطيور للدفء)، و**المماتنة** للتخفي زي الحرباء!`,
              spokenText: `الكائن الحي بيتميز بالتغذية والتنفس والتكاثر، وبيتكيف في جسمه تركيبي زي خف الجمل، ووظيفي في إفرازاته، وسلوكي في هجرة الطيور والمماتنة للتخفي.`
            },
            tier2: {
              answer: `الكبسولة السحرية لصفات الكائنات والتكيف:

1. **العمليات الحيوية:** التكاثر يحمي النوع من الانقراض، والتنفس يولد الطاقة، والإخراج يطرد السموم.
2. **أنواع التكيف:** تركيبي (عضو بالجسم)، وظيفي (إفراز سوائل)، سلوكي (أوقات وتصرفات).
3. **المماتنة:** التخفي لمحاكاة البيئة كالحرباء وحشرة العود.`,
              spokenText: `الكبسولة السريعة: التكاثر يحمي من الانقراض، والتكيف تركيبي في الجسم ووظيفي بالإفرازات وسلوكي بالتصرفات والمماتنة للتخفي!`
            }
          },
          'u3_l3_microbes': {
            title: 'الميكروبات',
            tier1: {
              answer: `تعال نبسط الميكروبات بتشبيه **سكان المدينة المجهرية الخفية**:
• الميكروبات كائنات صغيرة جداً لا نراها إلا بالمجهر: بكتيريا، فيروسات، فطريات، وأوليات مائية (زي الأميبا والبراميسيوم).
• **مش كلها أشرار!** بكتيريا الزبادي بتخمر اللبن، وفطر البنسيليوم صنعنا منه المضاد الحيوي، وفطر الخميرة بنعمل بيه العيش.. والضار منها بنحاربه بالنظافة واللقاحات والمناعة!`,
              spokenText: `الميكروبات كائنات مجهرية دقيقة، منها بكتيريا وفيروسات وفطريات، فيها النافع زي فطر البنسلين وبكتيريا الزبادي والخميرة، وفيها الضار اللي بنحاربه باللقاح والنظافة.`
            },
            tier2: {
              answer: `الكبسولة السحرية للميكروبات في 3 نقط:

1. **الكائنات الأولية:** الأميبا تتحرك بأقدام كاذبة، والبراميسيوم بالأهداب، واليوجلينا بالسوط.
2. **الفيروسات:** كائنات متطفلة إجبارياً على حافة الحياة لا تتكاثر إلا داخل العائل.
3. **الميكروبات النافعة:** البنسيليوم ينتج البنسلين، وبكتيريا اللبن تنتج الزبادي، وفطر الخميرة ينتج الخبز.`,
              spokenText: `الكبسولة السريعة: الأميبا أقدام كاذبة والبراميسيوم أهداب، والفيروسات متطفلة، والبنسيليوم مضاد حيوي وبكتيريا التخمر لصنع الزبادي!`
            }
          },
          'u4_l1_solar_system': {
            title: 'الأرض والنظام الشمسي',
            tier1: {
              answer: `تخيل النظام الشمسي زي **ساعة فلكية عملاقة وجميلة**:
• الشمس في النص وبيلف حواليها 8 كواكب، والأرض في المركز التالت وكوكب الحياة الأزرق (71% مياه).
• **حركتين للأرض بتظبط دنيتنا:** دوران الأرض حول نفسها كل 24 ساعة بيعمل **الليل والنهار**، ودورانها حول الشمس كل سنة مع ميل محورها 23.5 درجة بيعمل **الفصول الأربعة** (صيف، خريف، شتاء، ربيع)!`,
              spokenText: `الأرض الكوكب التالت في المجموعة الشمسية وكوكب الحياة، بتلف حول نفسها كل أربعة وعشرين ساعة لتعاقب الليل والنهار، وحول الشمس سنوياً لتعاقب فصول السنة الأربعة.`
            },
            tier2: {
              answer: `الكبسولة السحرية للأرض والنظام الشمسي:

1. **كوكب الحياة:** ماء 71%، غلاف جوي غني بالأكسجين، وأوزون يحمي من الأشعة فوق البنفسجية.
2. **دوران حول المحور (يومي):** تعاقب الليل والنهار.
3. **دوران حول الشمس + ميل المحور 23.5° (سنوي):** تعاقب فصول السنة الأربعة!`,
              spokenText: `الكبسولة السريعة: الأرض كوكب الحياة بالمية والأكسجين، دورانها حول محورها يعمل ليل ونهار، وحول الشمس بمحور مائل يعمل فصول السنة!`
            }
          },
          'u4_l2_eclipse': {
            title: 'خسوف القمر',
            tier1: {
              answer: `تعال نفهم خسوف القمر بلعبة **كشاف الموبايل في أوضة ضلمة**:
• لما تحط كفك قدام الكشاف، كفك بيحجب النور ويعمل ظل على الحيطة.
• **خسوف القمر (بالليل):** الأرض بتقف في النص بين الشمس والقمر على استقامة واحدة، فتحجب ضوء الشمس عن القمر فيضلم ويحمر ويبقى آمن تماماً للعين.
• **كسوف الشمس (بالنهار):** القمر هو اللي في النص ويحجب الشمس لدقايق وممنوع النظر ليه بدون نظارات!`,
              spokenText: `تخيل خسوف القمر بكشاف الموبايل، الأرض بتقف في النص بين الشمس والقمر بالليل وتحجب الضوء، والخسوف آمن للعين ويستمر لساعتين، وفي الكسوف القمر في النص نهاراً.`
            },
            tier2: {
              answer: `الكبسولة السحرية لخسوف القمر في كلمتين ونص:

1. **الشرط:** الأرض في المنتصف بين الشمس والقمر على استقامة واحدة في ليلة البدر.
2. **الأنواع:** خسوف كلي (القمر كله بمخروط الظل) وخسوف جزئي (لا يوجد خسوف حلقي للقمر).
3. **الأمان:** آمن 100% للرؤية بالعين المجردة بدون أي نظارات خاصة!`,
              spokenText: `الكبسولة السريعة: الأرض في النص يعني خسوف قمر بالليل وآمن للعين، قمر في النص يعني كسوف شمس بالنهار ويحتاج نظارات خاصة!`
            }
          }
        };

        // 3) قاموس المعرفة الشامل لدروس المنهج الـ 12 المعتمدة ومطابقة الكلمات المفتاحية
        const TOPIC_KNOWLEDGE = [
          ...
          },
          {
            ...
            primaryKeywords: [
              ...
              'قانون الكثافه', 'تطبيقات الكثافه', 'درجه الانصهار', 'درجه الغليان', 'توصيل كهربي', 'توصيل حراري', 'الصلابه'
            ],
            defaultSession: 1
          },
          {
          ...
          },
          {
            ...
            primaryKeywords: [
              'كهرباء', 'الكهرباء', 'قوى كهربيه', 'القوى الكهربيه', 'شحنه كهربيه', 'شحنات كهربيه', 
              'شحنه موجبه', 'شحنه سالبه', 'تجاذب وتنافر', 'كهرباء ساكنه', 'كهرباء استاتيكيه', 
              'دلك', 'شحن بالدلك', 'شحن باللمس', 'شحن بالتاثير', 'كشاف كهربي', 'ورقتا الكشاف', 
              'تيار كهربي', 'دائره كهربيه', 'موصلات', 'عوازل', 'سريان الالكترونات'
            ],
            defaultSession: 1
          },
          {
            ...
            unitName: 'الوحدة الثانية: مجالات القوى',
            primaryKeywords: [
              'مغناطيس', 'المغناطيس', 'قوى مغناطيسيه', 'القوى المغناطيسيه', 'مجال مغناطيسي', 'المجال المغناطيسي', 
              'خطوط الفيض', 'خطوط المجال', 'قطب شمالي', 'قطب جنوبي', 'اقطاب مغناطيسيه', 'مغناطيس كهربي', 
              'المغناطيس الكهربي', 'دينامو', 'مولد كهربي', 'محرك كهربي', 'موتور', 'بوصله', 'البوصله المغناطيسيه', 
              'حديد مطاوع', 'تمغنط', 'مواد مغناطيسيه'
            ],
            defaultSession: 1
          },
          {
            ...
            unitName: 'الوحدة الثانية: مجالات القوى',
            primaryKeywords: [
              'جاذبيه', 'الجاذبيه', 'قوى الجاذبيه', 'جاذبيه ارضيه', 'الجاذبيه الارضيه', 'نيوتن', 'اسحاق نيوتن', 
              'تفاحه نيوتن', 'وزن', 'الوزن', 'كتله ووزن', 'الفرق بين الكتله والوزن', 'عجله الجاذبيه', 
              'مركز الثقل', 'ميزان زنبركي', 'جاذبيه القمر', 'سدس جاذبيه الارض', 'قانون الوزن', 'و = ك × ج'
            ],
            defaultSession: 1
          },
          {
            ...
            primaryKeywords: [
              ...
              'ميتوكوندريا', 'عضيات', 'وحده البناء والوظيفه', 'روبرت هوك', 'المجهر', 'سنتروسوم', 'جسم مركزي', 'ريبوسومات', 'dna'
            ],
            defaultSession: 1
          },
          {
            ...
            unitName: 'الوحدة الثالثة: الكائنات الحية تركيبها وعملياتها',
            primaryKeywords: [
              'صفات عامه', 'صفات الكائنات', 'خصائص حيويه', 'تغذيه', 'تنفس', 'اخراج', 'تكاثر', 'احساس', 'حركه', 'نمو', 
              'تكيف', 'التكيف', 'تنوع الكائنات', 'تكيف تركيبي', 'تكيف وظيفي', 'تكيف سلوكي', 
              'بيات شتوي', 'خمول صيفي', 'هجره الطيور', 'مماتنه', 'المماتنه', 'حرباء', 'الحرباء', 'حشره العود', 
              'حشره ورقيه', 'خف الجمل', 'حافر الحصان', 'منقار الصقر', 'سم الثعبان'
            ],
            defaultSession: 1
          },
          {
            ...
            unitName: 'الوحدة الثالثة: الكائنات الحية تركيبها وعملياتها',
            primaryKeywords: [
              'ميكروب', 'ميكروبات', 'الميكروبات', 'كائنات دقيقه', 'الكائنات الدقيقه', 'بكتيريا', 'البكتيريا', 
              'فيروس', 'فيروسات', 'الفيروسات', 'فطريات', 'الفطريات', 'اوليات مجهريه', 'كائنات اوليه', 
              'اميبا', 'الاميبا', 'براميسيوم', 'البراميسيوم', 'يوجلينا', 'اليوجلينا', 'فطر الخميره', 
              'فطر البنسيليوم', 'بنسلين', 'مضاد حيوي', 'بكتيريا الزبادي', 'حمض اللاكتيك', 'بكتيريا عقديه', 
              'لقاحات', 'مناعه', 'تعقيم', 'بستره'
            ],
            defaultSession: 1
          },
          {
            ...
            primaryKeywords: [
              'ارض', 'الارض', 'كوكب الارض', 'نظام شمسي', 'المجموعه الشمسيه', 'كواكب', 'كواكب المجموعه الشمسيه', 
              'عطارد', 'الزهره', 'المريخ', 'المشتري', 'زحل', 'اورانوس', 'نبتون', 'كوكب الحياه', 'كوكب ازرق', 
              'غلاف جوي', 'غلاف مائي', 'دوران الارض', 'دوران الارض حول محورها', 'دوران الارض حول الشمس', 
              'تعاقب الليل والنهار', 'فصول السنه', 'فصول السنه الاربعه', 'ميل محور الارض', '23.5'
            ],
            defaultSession: 1
          },
          {
            ...
            unitName: 'الوحدة الرابعة: نظام (الأرض - الشمس - القمر)',
            primaryKeywords: [
              'خسوف', 'خسوف القمر', 'الخسوف', 'كسوف', 'كسوف الشمس', 'الكسوف', 'مخروط الظل', 'شبه الظل', 
              'خسوف كلي', 'خسوف جزئي', 'كسوف كلي', 'كسوف جزئي', 'كسوف حلقي', 'استقامه واحده', 
              'حجب ضوء الشمس', 'اطوار القمر', 'محاق', 'هلال', 'بدر', 'تربيع', 'احدب', 'القمر بدرا'
            ],
            defaultSession: 1
          }
        ];

        // 3.5) معالجة عبارات "مش فاهم" والتبسيط المتدرج (Multi-Tier Progressive Simplification)
        const notUnderstoodTriggers = [
          'مش فاهم', 'مش فاهمه', 'مش فاهم حاجه', 'مش فاهم اوي', 'مش فاهمها',
          'مفهمتش', 'مفهمتهاش', 'ما فهمت', 'ما فهمتش', 'لسه مش فاهم', 'مش مستوعب',
          'بسط اكتر', 'بسطهالي', 'بسطها', 'بسط اكتر من كده', 'بسطهالي اكتر',
          'فهمني اكتر', 'اشرحلي اكتر', 'اشرح اكتر', 'وضح اكتر', 'وضحلي اكتر', 'وضح اكتر من كده',
          'صعبه', 'صعبه اوي', 'معقده', 'مش واضحه', 'اشرح بطريقه اسهل', 'اشرح باسلوب اسهل',
          'اشرح بالبلدي', 'عيد تاني', 'كرر تاني', 'مش فاهم الدرس', 'وضحلي تاني', 'قول تاني',
          'تقدر تبسط', 'مش قادر افهم', 'لسه صعبه', 'تقيله', 'مش داخله دماغي', 'صعب'
        ];
        const isSimplificationRequest = notUnderstoodTriggers.some(t => qNorm.includes(t)) || qNorm === 'مش فاهم' || qNorm === 'بسط';

        if (isSimplificationRequest) {
          let detectedTopicId = null;
          for (const topicItem of TOPIC_KNOWLEDGE) {
            for (const kw of topicItem.primaryKeywords) {
              ...
              if (qNorm.includes(kwNorm)) {
                detectedTopicId = topicItem.lessonId;
                break;
              }
            }
            if (detectedTopicId) break;
          }

          const targetTopicId = detectedTopicId || this._lastTopicId || this._currentLesson?.lessonId || 'u1_l1_atom';
          
          if (detectedTopicId && detectedTopicId !== this._lastTopicId) {
            this._simplificationLevel = 1;
          } else {
            this._simplificationLevel = (this._simplificationLevel || 0) + 1;
          }
          this._lastTopicId = targetTopicId;

          const simpData = SIMPLIFIED_EXPLANATIONS[targetTopicId] || SIMPLIFIED_EXPLANATIONS['u1_l1_atom'];
          const isTier2 = this._simplificationLevel >= 2;
          const currentTier = isTier2 ? simpData.tier2 : simpData.tier1;

          resolve({
            answer: currentTier.answer,
            spokenText: currentTier.spokenText,
            topic: targetTopicId,
            topicAr: simpData.title,
            hasExplanation: true,
            topicContent: null,
            isOutOfCurriculum: false,
            actions: [
              { label: `فتح درس ${simpData.title}`, action: `window.appController.selectLessonSession('${targetTopicId}', 1)` },
              { label: 'المعمل التفاعلي ثلاثي الأبعاد (3D)', action: `window.appController.selectLessonSession('${targetTopicId}', 1)` },
              ...(isTier2 ? [] : [{ label: 'كبسولة التبسيط الفائقة (مستوى أسهل)', action: `window.appController.quickAskChat('بسطهالي اكتر')` }])
            ]
          });
          return;
        }
        ...
        if (matchedWhy && matchedWhyLesson) {
          this._lastTopicId = matchedWhyLesson.lessonId;
          this._simplificationLevel = 0;
        ...
        if (bestTopic && bestScore >= 25) {
          this._lastTopicId = bestTopic.lessonId;
          this._simplificationLevel = 0;
